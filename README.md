...
file_to_load = os.path.join("/Users/rohansalwi/Desktop/Assignment Projects/Python/Election-Analysis/Resources/Election-Analysis", "election_results.csv")
#### Add a variable to save the file to a path.
file_to_save = os.path.join("/Users/rohansalwi/Desktop/Assignment Projects/Python/Election-Analysis/Resources/Election-Analysis", "election_analysis.txt")
...
#### 6f: Write an if statement to determine the winning county and get its vote count.
        if (cvotes > winning_county_count) and (cvote_percentage > county_percentage):
